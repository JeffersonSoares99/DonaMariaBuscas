...
public class CadastroBebidaActivity extends AppCompatActivity {
    ...
    public void uploadImage() {
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("RecipeImageBebida").child(uri.getLastPathSegment());
...
*/
        ...
        FirebaseDatabase.getInstance().getReference("RecipeBebida").child(myCurrentDateTime).setValue(produtos).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {

                    Toast.makeText(CadastroBebidaActivity.this, "Cadastro realizado", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CadastroBebidaActivity.this, CategoriaBebidaActivity .class);
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CadastroBebidaActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
