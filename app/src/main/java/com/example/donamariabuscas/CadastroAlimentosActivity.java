...
public class CadastroAlimentosActivity extends AppCompatActivity {
    ...
    public void uploadImage() {
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("RecipeImageAlimentos").child(uri.getLastPathSegment());
...
*/
        ...
        FirebaseDatabase.getInstance().getReference("RecipeAlimentos").child(myCurrentDateTime).setValue(categoriaAlimentosBasicos).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {

                    Toast.makeText(CadastroAlimentosActivity.this, "Cadastro realizado", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CadastroAlimentosActivity.this, CategoriaABActivity .class);
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CadastroAlimentosActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
