...
public class UpdateLimpezaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_limpeza);
        ...
        if (bundle != null) {
            Glide.with(UpdateLimpezaActivity.this)
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("RecipeLimpeza").child(key);
    ...
    public void btnUpdateRecipe(View view) {
        ...
        storageReference = FirebaseStorage.getInstance()
                .getReference().child("RecipeImageLimpeza").child(uri.getLastPathSegment());
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                uploadRecipe();
                Intent intent = new Intent(UpdateLimpezaActivity.this, CategoriaLimpezaActivity.class);
...
*/
        ...
        databaseReference.setValue(categoriaLimpeza).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(UpdateLimpezaActivity.this, "Produto Editado", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
