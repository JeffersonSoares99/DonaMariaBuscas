...
public class DetalheBebidaActivity extends AppCompatActivity {
    ...
    public void btnDeleteRecipe(View view) {
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("RecipeBebida");
        ...
        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(DetalheBebidaActivity.this, "Produto Excluido", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(DetalheBebidaActivity.this, CategoriaBebidaActivity.class));
                finish();
    ...
    public void btnUpdateRecipe(View view) {
        startActivity(new Intent(getApplicationContext(),UpdateBebidaActivity.class)
