...
public class DetalheCarneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_carne);
    ...
    public void btnDeleteRecipe(View view) {
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("RecipeCarne");
        ...
        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(DetalheCarneActivity.this, "Produto Excluido", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(DetalheCarneActivity.this, CategoriaCarneActivity.class));
                finish();
    ...
    public void btnUpdateRecipe(View view) {
        startActivity(new Intent(getApplicationContext(),UpdateCarneActivity.class)
