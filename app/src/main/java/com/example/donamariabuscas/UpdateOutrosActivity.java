...
public class UpdateOutrosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_outros);
        ...
        if (bundle!=null) {
            Glide.with(UpdateOutrosActivity.this)
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("RecipeOutros").child(key);
    ...
    public void btnUpdateRecipe(View view) {
        ...
        storageReference =  FirebaseStorage.getInstance()
                .getReference().child("RecipeImageOutros").child(uri.getLastPathSegment());
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                uploadRecipe();
                Intent intent = new Intent(UpdateOutrosActivity.this, CategoriaOutrosActivity.class);
...
*/
        ...
        databaseReference.setValue(categoriaOutros).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(UpdateOutrosActivity.this, "Produto Editado", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
