...
public class CategoriaOutros {
    ...
    public CategoriaOutros() {
    }

    public CategoriaOutros(String itemName, String itemDescription, String itemPrice, String itemMercado, String itemEndereco, String itemImage) {
