...
public class CategoriaAlimentosBasicos {
    ...
    public CategoriaAlimentosBasicos() {
    }

    public CategoriaAlimentosBasicos(String itemName, String itemDescription, String itemPrice, String itemMercado, String itemEndereco, String itemImage) {
