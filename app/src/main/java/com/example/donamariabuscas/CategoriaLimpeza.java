...
public class CategoriaLimpeza {
    ...
    public CategoriaLimpeza() {
    }

    public CategoriaLimpeza(String itemName, String itemDescription, String itemPrice, String itemMercado, String itemEndereco, String itemImage) {
