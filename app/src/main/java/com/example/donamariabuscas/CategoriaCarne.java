...
public class CategoriaCarne {
    ...
    public CategoriaCarne() {
    }

    public CategoriaCarne(String itemName, String itemDescription, String itemPrice, String itemMercado, String itemEndereco, String itemImage) {
