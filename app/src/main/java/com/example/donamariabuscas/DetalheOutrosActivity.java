...
public class DetalheOutrosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_outros);
    ...
    public void btnDeleteRecipe(View view) {
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("RecipeOutros");
        ...
        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(DetalheOutrosActivity.this, "Produto Excluido", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(DetalheOutrosActivity.this, CategoriaOutrosActivity.class));
                finish();
    ...
    public void btnUpdateRecipe(View view) {
        startActivity(new Intent(getApplicationContext(),UpdateOutrosActivity.class)
