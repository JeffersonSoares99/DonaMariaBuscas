...
public class DetalheLimpezaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalhe_limpeza);
    ...
    public void btnDeleteRecipe(View view) {
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("RecipeLimpeza");
        ...
        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(DetalheLimpezaActivity.this, "Produto Excluido", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(DetalheLimpezaActivity.this, CategoriaLimpezaActivity.class));
                finish();
    ...
    public void btnUpdateRecipe(View view) {
        startActivity(new Intent(getApplicationContext(),UpdateLimpezaActivity.class)
