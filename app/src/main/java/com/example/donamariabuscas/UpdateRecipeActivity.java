    ...
    public void btnUpdateRecipe(View view) {
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                uploadRecipe();
                Intent intent = new Intent(UpdateRecipeActivity.this, ProdutosActivity.class);
...
*/
        ...
        databaseReference.setValue(produtos).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(UpdateRecipeActivity.this, "Produto Editado", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
