...
public class CadastroCarneActivity extends AppCompatActivity {
    ...
    public void uploadImage() {
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("RecipeImageCarne").child(uri.getLastPathSegment());
...
*/
        ...
        FirebaseDatabase.getInstance().getReference("RecipeCarne").child(myCurrentDateTime).setValue(categoriaCarne).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {

                    Toast.makeText(CadastroCarneActivity.this, "Cadastro realizado", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CadastroCarneActivity.this, CategoriaCarneActivity.class);
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CadastroCarneActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
