...
public class UpdateBebidaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_bebida);
        ...
        if (bundle!=null) {
            Glide.with(UpdateBebidaActivity.this)
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("RecipeBebida").child(key);
    ...
    public void btnUpdateRecipe(View view) {
        ...
        storageReference =  FirebaseStorage.getInstance()
                .getReference().child("RecipeImageBebida").child(uri.getLastPathSegment());
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                uploadRecipe();
                Intent intent = new Intent(UpdateBebidaActivity.this, CategoriaBebidaActivity.class);
...
*/
        CategoriaBebida categoriaBebida = new CategoriaBebida(
        ...
        databaseReference.setValue(categoriaBebida).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(UpdateBebidaActivity.this, "Produto Editado", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
